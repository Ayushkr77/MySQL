...
-- 2. Find the name, department ID, and name of all the employees 
SELECT 
e.first_name, 
e.last_name, 
e.department_id, 
...
-- 3. Find the name, job, department ID, and name of the employees who work in London 
SELECT 
e.first_name, 
e.last_name, 
e.job_id, 
...
-- 4. Find the employee ID, name along with their manager ID, and name 
SELECT 
e.employee_id, 
...
-- 5. Find the name and hire date of the employees who were hired after 'Jones' 
SELECT 
e.first_name, 
e.last_name, 
e.hire_date 
...
employees e 
JOIN 
employees j ON j.last_name = 'Jones' 
WHERE 
...
-- 7. Display department name, name, hire date, salary of the manager for all managers whose experience is more than 15 years 
SELECT 
d.department_name, 
m.first_name, 
m.last_name, 
...
WHERE 
TIMESTAMPDIFF(YEAR, m.hire_date, CURDATE()) > 15; 



-- 8. Find the name and salary of the employees who have a higher salary than the employee whose last_name='Bull' 
SELECT 
e.first_name, 
e.last_name, 
e.salary 
...
-- 9. Find the name of all employees who work in the IT department 
SELECT 
e.first_name, 
e.last_name 
FROM  
...
-- 10. Find the name of the employees who have a manager and worked in a USA based department 
SELECT 
e.first_name, 
e.last_name 
FROM  
...
-- 11. Find the name and salary of the employees whose salary is greater than the average salary 
SELECT 
e.first_name, 
e.last_name, 
e.salary 
...
-- 12. Find the name and salary of the employees whose salary is equal to the minimum salary for their job grade 
SELECT 
e.first_name, 
e.last_name, 
e.salary 
...
-- 13. Find the name and salary of the employees who earn more than the average salary and work in any of the IT departments 
SELECT 
e.first_name, 
e.last_name,  
e.salary 
...
-- 14. Find the name and salary of the employees who earn the same salary as the minimum salary for all departments 
SELECT 
e.first_name, 
e.last_name, 
e.salary 
...
employees e 
WHERE 
e.salary IN (SELECT MIN(salary) FROM employees GROUP BY department_id); 


-- 15. Find the name and salary of the employees who earn a salary that is higher than the salary of all the Shipping Clerk (JOB_ID = 'SH_CLERK') 
SELECT 
e.first_name, 
e.last_name, 
e.salary  
